...
import getCarByCategory from '@/app/libs/getCarByCategory'
...
export async function generateMetadata({ params: { categoryName } }: Props) {
  return {
    title: categoryName,
...
const page = async ({ params: { categoryName } }: Props) => {
  const data = getCarByCategory(categoryName)
  return (
    <div>
